...
export async function createNotification(
  userId: string,
  type: 'payment_received' | 'payment_sent' | 'invoice_created' | 'invoice_paid' | 'subscription_renewed' | 'subscription_paused' | 'subscription_renewal_failed' | 'threshold_alert' | 'workflow_executed' | 'payment_request' | 'savings_goal_reached',
  title: string,
  message: string,
  metadata: any = {}
) {
